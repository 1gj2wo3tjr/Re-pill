...
function AddressEditModal({ address, setAddress, open, setOpen, data }) {
  ...
  const registerAddress = () => {
    ...
    if (!address.zonecode) {
      axios
        .put(
          `${process.env.REACT_APP_BASE_URL}/api/v1/accounts/address/${data.id}/`,
          {
        ...
        <div>
          ...
          >
            <Modal.Content>
              ...
              >
                <div style={{ fontSize: "1rem", width: "40%" }}>
                  받는사람이름
                </div>
                ...
                <TableCell style={{ fontSize: "1rem", width: "60%" }}>
                  ...
                  >
                    <div style={{ display: "flex" }}>
                      ...
                      <button onClick={openPopup} style={{ marginLeft: "3%" }}>
                        검색
                      </button>
                    </div>
                    {address ? (
              ...
              >
                <button
                  ...
                  className={styles.address_edit_check_button_mob}
                >
                  수정
                </button>
                <button
                  onClick={cancleModal}
                  className={styles.address_edit_cancle_button_mob}
                >
                  취소
                </button>
              </div>
        ...
        <div>
          ...
          >
            <Modal.Content>
              ...
              >
                <TableCell style={{ fontSize: "1.3rem", width: "40%" }}>
                  받는사람이름
                </TableCell>
                <TableCell style={{ fontSize: "1.4rem", width: "60%" }}>
                  <input
                    type="text"
                    onChange={onChange}
                    value={form.address_name}
                ...
                <TableCell style={{ fontSize: "1.3rem", width: "60%" }}>
                  ...
                  >
                    <div style={{ display: "flex" }}>
                      ...
                      <button onClick={openPopup} style={{ marginLeft: "1%" }}>
                        주소검색
                      </button>
                    </div>
                    {address ? (
            ...
            <Modal.Actions>
              <button
                onClick={registerAddress}
                className={styles.address_register_button}
              >
                등록
              </button>
              <button
                onClick={cancleModal}
                className={styles.address_cancle_button}
              >
                취소
              </button>
            </Modal.Actions>
