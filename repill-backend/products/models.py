...
class Ingrediant(models.Model):
    ...
    dose_recomm = models.PositiveIntegerField(blank=True, null=True)    # 일일 섭취 권장량
    dose_recomm_metrics = models.CharField(max_length=10, blank=True, null=True)     # 권장량 표기 단위
...
class Included(models.Model):
    ...
    # 부가 정보
    dose = models.PositiveIntegerField(blank=True, null=True)                                    # 함유량
    dose_metrics = models.CharField(max_length=10, blank=True, null=True)                        # 함유량 표기 단위
